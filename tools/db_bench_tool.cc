...
static DataBlockIndexType StringToDataBlockIndexType(const char* ctype
  ...
  else if (!strcasecmp(ctype, "mse"))
    return rocksdb::BlockBasedTableOptions::kDataBlockMseIndex;
  ...
  void PrintHeader() {
    ...
    switch (FLAGS_data_block_index_type_e) {
      ...
      case rocksdb::BlockBasedTableOptions::kDataBlockHashIndex:
        ...
        break;
      case rocksdb::BlockBasedTableOptions::kDataBlockMseIndex:
        fprintf(stdout, "DataBlockIndexType: mse\n");
        break;
    }
