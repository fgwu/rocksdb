...
enum Tickers : uint32_t {
  ...
  DATA_BLOCK_HASH_INDEX_TABLE_BUILD_CMP_OK,
  DATA_BLOCK_HASH_INDEX_TABLE_BUILD_TYPE_OK,
  DATA_BLOCK_HASH_INDEX_TABLE_BUILD_BOTH_OK,
  DATA_BLOCK_HASH_INDEX_TABLE_BUILD_TOTAL,
  DATA_BLOCK_HASH_INDEX_BLOCK_BUILD_HASH,
  DATA_BLOCK_HASH_INDEX_BLOCK_BUILD_TOTAL,
  DATA_BLOCK_HASH_INDEX_BLOCK_READ_HASH,
  DATA_BLOCK_HASH_INDEX_BLOCK_READ_TOTAL,
  // # of cases when DataBlockHashIndex succeeds
  DATA_BLOCK_HASH_INDEX_SUCCESS_NO_ENTRY,
  DATA_BLOCK_HASH_INDEX_SUCCESS_BLK_END,
  DATA_BLOCK_HASH_INDEX_SUCCESS_NOT_EXIST,
  DATA_BLOCK_HASH_INDEX_SUCCESS_FOUND,
  // # of cases when DataBlockHashIndex falls back to binary seek.
  DATA_BLOCK_HASH_INDEX_FALLBACK_NULL,
  DATA_BLOCK_HASH_INDEX_FALLBACK_COLLISION,
  DATA_BLOCK_HASH_INDEX_FALLBACK_TYPE,
...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {DATA_BLOCK_HASH_INDEX_TABLE_BUILD_CMP_OK,
     "rocksdb.data.block.hash.index.table.build.cmp.ok"},
    {DATA_BLOCK_HASH_INDEX_TABLE_BUILD_TYPE_OK,
     "rocksdb.data.block.hash.index.table.build.type.ok"},
    {DATA_BLOCK_HASH_INDEX_TABLE_BUILD_BOTH_OK,
     "rocksdb.data.block.hash.index.table.build.both.ok"},
    {DATA_BLOCK_HASH_INDEX_TABLE_BUILD_TOTAL,
     "rocksdb.data.block.hash.index.table.build.total"},
    {DATA_BLOCK_HASH_INDEX_BLOCK_BUILD_HASH,
     "rocksdb.data.block.hash.index.block.build.hash"},
    {DATA_BLOCK_HASH_INDEX_BLOCK_BUILD_TOTAL,
     "rocksdb.data.block.hash.index.block.build.total"},
    {DATA_BLOCK_HASH_INDEX_BLOCK_READ_HASH,
     "rocksdb.data.block.hash.index.block.read.hash"},
    {DATA_BLOCK_HASH_INDEX_BLOCK_READ_TOTAL,
     "rocksdb.data.block.hash.index.block.read.total"},
    {DATA_BLOCK_HASH_INDEX_SUCCESS_NO_ENTRY,
     "rocksdb.data.block.hash.index.success.no.entry"},
    {DATA_BLOCK_HASH_INDEX_SUCCESS_BLK_END,
     "rocksdb.data.block.hash.index.success.blk.end"},
    {DATA_BLOCK_HASH_INDEX_SUCCESS_NOT_EXIST,
     "rocksdb.data.block.hash.index.success.not.exist"},
    {DATA_BLOCK_HASH_INDEX_SUCCESS_FOUND,
     "rocksdb.data.block.hash.index.success.found"},
    {DATA_BLOCK_HASH_INDEX_FALLBACK_NULL,
     "rocksdb.data.block.hash.index.fallback.null"},
    {DATA_BLOCK_HASH_INDEX_FALLBACK_COLLISION,
     "rocksdb.data.block.hash.index.fallback.collision"},
    {DATA_BLOCK_HASH_INDEX_FALLBACK_TYPE,
     "rocksdb.data.block.hash.index.fallback.type"},
    {DATA_BLOCK_HASH_INDEX_SEEK_FOR_GET,
